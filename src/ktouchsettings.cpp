...
void KTouchSettings::loadSettings() {
	...
	//TODO How is the default lecture chosen? Shouldn't the default lecture be the user KDE language?
	//Otherwise it should be en
	...
	//find user language -> set lecture as default
