...
///
/// Please refer to the documentation 'sliding_line.pdf' in the KTouch/extras folder.
class KTouchSlideLine : public QWidget {
  ...
  private:
    ...
    QPixmap    *m_teacherPixmap;    ///< Pixmap used to draw the teacher sliding line, created in rebuildLines().
    QPixmap    *m_studentPixmap;    ///< Pixmap used to draw the student sliding line, created in rebuildLines().
