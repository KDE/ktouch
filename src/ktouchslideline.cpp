...
void KTouchSlideLine::setStudentText(const QString& text) {
    ...
    m_studentText=text;
    // FIXME : do we really have to enable the cursor here?
...
//           	m_teacherPixmap, int_xFrameTeacherCurrent, 0, m_slideLineWidth, m_slideLineHeight);
		QRectF teacher_source(int_xFrameTeacherCurrent, 0, 
							  m_slideLineWidth, m_slideLineHeight);
		QRectF teacher_target(m_marginHorWidget, m_marginVerWidget, 
                              m_slideLineWidth, m_slideLineHeight);
...
//           	m_studentPixmap, int_xFrameStudentCurrent, 0, m_slideLineWidth, m_slideLineHeight);
		QRectF student_source(int_xFrameStudentCurrent, 0, 
                              m_slideLineWidth, m_slideLineHeight);
		QRectF student_target(m_marginHorWidget, m_marginVerWidget + m_slideLineHeight + m_slideLineDist,
                              m_slideLineWidth, m_slideLineHeight);
